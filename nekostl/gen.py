...
def spirv():
	...
	with open("../dependencies/SPIRV-Headers/include/spirv/unified1/spirv.hpp") as c, open("modules/spirv.neko", "w") as k:
		line = c.readline()
		while line:
...
def glsl():
	...
	with open("../dependencies/SPIRV-Headers/include/spirv/unified1/GLSL.std.450.h") as c, open("modules/glslext.neko", "w") as k:
		line = c.readline()
		while line:
			rep = constant.sub("const \\1 := \\2;", line)
			if rep != line:
...
def ocl():
	...
	with open("../dependencies/SPIRV-Headers/include/spirv/unified1/OpenCL.std.h") as c, open("modules/openclext.neko", "w") as k:
		for x in range(217):
			c.readline()
		line = c.readline()
		while line:
