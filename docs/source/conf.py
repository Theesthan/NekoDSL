...
breathe_projects = {
   'neko': abspath('../build/doxygen/xml/')
}
...
latex_documents = [
    (master_doc, 'Neko.tex', 'Neko Documentation',
...
man_pages = [
    (master_doc, 'neko', 'Neko Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Neko', 'Neko Documentation',
     author, 'Neko', 'Neko is a shader language and compiler written in C++.',
     'Miscellaneous'),
]
